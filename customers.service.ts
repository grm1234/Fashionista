...
export class CustomersService {
  ...
  // URL to web api
  private customersUrl = 'http://localhost:5000/shop/customers';
  ...
  addCustomers(customer: Customers):Observable<any>{
      return this.http.post<any>(this.customersUrl, customer, httpOptions);
  }
